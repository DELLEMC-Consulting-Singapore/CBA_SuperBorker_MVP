...
export const DevBox = () => {
  return (
    <>
        <Card
        style={{ width: "100%", "min-height": "11rem",
    "padding": "0",
    ...
    actions={[
    <Link to={"/devbox/request-vm"}><a className='anchor-tag'>Explore
      
      <i class="dds__icon--arrow-right" style={
        {
            "cursor": "pointer",
            "color": "#0672cb",
            "font-size": "20px",
  ...
  >
    ...
    "font-size": "16px",
    margin: 0
    }}>Assigns a pre-provisioned VM with root/admin to the user for 48 hours</Paragraph>
  </Card>
